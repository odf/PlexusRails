...
describe "A DAG" do
  ...
  context "with some interesting bottlenecks" do
    before :all do
      @dag = Pazy::DAG.new + [ [1,2], [3,4], [2,4], [2,5], [4,6],
                         [6,7], [6,8], [7,9], [8,9] ]
    end
  ...
  context "with another set of interesting bottlenecks" do
    before :all do
      @dag = Pazy::DAG.new + [ [1,2], [3,4], [3,2], [2,5], [4,5], [4,6] ]
    end
  ...
  context "with a third set of interesting bottlenecks" do
    before :all do
      @dag = Pazy::DAG.new + [ [0,1], [0,3], [1,2], [3,4], [3,2], [2,5], [4,5], [4,6] ]
    end
